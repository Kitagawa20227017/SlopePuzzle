...
public class KeyBoardInput : MonoBehaviour
{
    ...
    // RayCastの位置
    private const float RAY_POS_ADVENT_SUITED = 0.5001f;
    private const float RAY_POS_ADVENT_OPPOSITE = 0.30f;
    ...
    private void Update()
    {
        ...
        // キーボード入力受け付け
        xPos = _speed * Input.GetAxis("Horizontal");
        yPos = _speed * Input.GetAxis("Vertical");
